TEAM CHARTER — [Product Analytics]

LIIKMED:
1. Johanna (OS: Win)  Roll nädal 1: NotebookLM Seadistaja
2. Katri (OS: Win)  Roll nädal 1: Supabase Seadistaja
3. Merili (OS: Win)  Roll nädal 1: GitHub Repo Seadistaja + Team Charter Seadistaja

ÜHISED TÖÖRIISTAD:
Suhtluskanal: Google Workspace Chat
GitHub repo:  product-analytics
Supabase:     urbanstyle-product-analytics
NotebookLM:   Urban Style --Product Analytics

KOKKULEPPED:
1. Kuidas me üksteist aitame, kui keegi jääb kinni?
   Küsime ja anname nõu.
